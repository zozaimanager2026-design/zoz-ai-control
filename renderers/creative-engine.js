...
function policy(){return {version:1,owner:"ZOZ AI",primary:"zoz-native-image-renderer",freeFallback:"explicit-only",paidProviders:"optional-only",humanApprovalRequiredForFinance:true,video:"adapter-ready; GPU required for heavy generation"};}
...
module.exports={policy,image,execute};