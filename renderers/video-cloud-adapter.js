...
const PROVIDERS = Object.freeze({
  creatomate: { endpoint: "https://api.creatomate.com/v2/renders", keyEnv: "CREATOMATE_API_KEY" },
  shotstack: { endpoint: "https://api.shotstack.io/v1/render", keyEnv: "SHOTSTACK_API_KEY" }
});
