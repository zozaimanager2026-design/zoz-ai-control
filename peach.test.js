...
const payload = buildPeachTemplatePayload({
  to: "+201001234567",
  templateId: "wat_test_template",
  liquidValues: { customer_name: "Test Customer", product_name: "Freezer", price: 12000 },
  name: "Test Customer",
  businessPhoneNumber: "201099999999"
});
...
const peachReplyPayload = {
  ...
  data: {
    message: {
      ...
      reason: "",
      reply: { id: 1, author: { name: "Test Customer", phone_number: "+201001234567" }, text: "محتاج تكييف 3 حصان" }
    },
    contact: { name: "Test Customer", phone_number: "+201001234567" },
    event: null
  }
};
